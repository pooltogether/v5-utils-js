...
export const TWAB_CONTROLLER_SUBGRAPH_URIS = {
  ...
  [CHAIN_ID.sepolia]: `https://api.studio.thegraph.com/query/41211/v5-twab-controller-eth-sepolia/v0.0.2`,
};
...
export const PRIZE_POOL_SUBGRAPH_URIS = {
  ...
  [CHAIN_ID.sepolia]: `https://api.studio.thegraph.com/query/41211/v5-prize-pool-eth-sepolia/v0.0.2`,
};
