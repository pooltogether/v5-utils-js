...
describe('computeDrawResults', () => {
    it('should return a draw result with zero winning picks', () => {
        ...
        let results = computeDrawResults(DRAW_EXAMPLE, picks, PRIZE_DISTRIBUTION.bitRangeSize, PRIZE_DISTRIBUTION.matchCardinality, PRIZE_DISTRIBUTION.prize, PRIZE_DISTRIBUTION.tiers);
        expect(results.drawId).toEqual(1);
        expect(results.totalValue).toEqual(BigNumber.from('0'));
    });
});
//# sourceMappingURL=computeDrawWinners.test.js.map